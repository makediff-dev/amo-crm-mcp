...
const eventValueItemSchema = z.object({
  // Note events
  note: z.object({
    id: z.number()
  }).optional(),
  ...
  leads_statuses: z.array(z.object({
    id: z.number(),
    pipeline_id: z.number()
  })).optional(),
  
  // Customer statuses array
  customers_statuses: z.array(z.object({
    id: z.number(),
    pipeline_id: z.number().optional()
  })).optional()
}).passthrough();
...
export const getEventsInputSchema = z.object({
  ...
  page: z.number().int().positive().optional()
    .describe('Номер страницы для пагинации'),
